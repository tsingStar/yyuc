...
class Index{
	...
	public function _trans() {
		if(!@file_exists($this->com_path) || filemtime($this->com_path)<filemtime($this->view_path) || Conf::$is_developing){
			...
			$appdenstr = '</title><script type="text/javascript" src="'.$jquery.'"></script><script type="text/javascript">window.yyuc_remotepath = "'.Conf::$remote_path.'";window.yyuc_jspath = "'.Page::asset('@system/').'";</script><script type="text/javascript" src="'.$jyyuc.'"></script>';
