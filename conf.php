...
/////////////////////特殊路由设置
	...
	public static $email = array(
			...
			'findpwd'=>array('protocol'=>'smtp','smtp_host'=>'smtp.exmail.qq.com','smtp_user'=>'findpassword@uhqq.com','smtp_pass'=>'QQiFF1314','from'=>array('findpassword@uhqq.com','密码找回'))
	);
...
/////////////////////缓存及文件存储配置
	...
	/**Redis连接信息~*/
	public static $redis = array('127.0.0.1','6379');
