	...
	_.loadyyucobj = function(justload){
		...
		if(inphidden.size()>0){
			...
			if(eval('"undefined" == typeof '+obj)){
				...
				}else if(obj=='yyuctimepick'){
					getStyle(yyuc_jspath+'datePicker/datepicker/bootstrap-clockpicker.min.css');
					jQuery.getScript(yyuc_jspath+'datePicker/datepicker/bootstrap-clockpicker.min.js',function(){	
						jQuery('[relobj="yyuctimepick"]').clockpicker();
						_.loadyyucobj();
					});
				}else {
